...
def _perform_scan(
    *,
    ...
    result = ScanResponse(
        scan_id=str(scan_id),
        created_at=created_at.isoformat(),
        ai_visibility_score=int(result_obj.ai_visibility_score),
        ...
        visibility_status=result_obj.visibility_status,
        confidence_level=result_obj.confidence_level,
        evidence_summary=result_obj.evidence_summary,
        verified_facts=list(result_obj.verified_facts or []),
        unclear_facts=list(result_obj.unclear_facts or []),
        missing_signals=list(result_obj.missing_signals or []),
        limitations=list(result_obj.limitations or []),
        proof_signals=list(result_obj.proof_signals or []),
